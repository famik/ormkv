...
class KspOrmkvProcessor(
    ...
    private fun generateClass(
        ...
        val useInitBlock = entityArgs["init"] as? Boolean ?: true
        val useSingleton = entityArgs["singleton"] as? Boolean ?: false
